 ...
 const Add = () => {
  ...
  return (
    ...
    <form onSubmit={addHandler} className='absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-md w-full'>
      ...
      <textarea value={data.description} onChange={e => setData({...data,description:e.target.value})} maxLength={100} type="text" placeholder="Description (optional)" className="bg-white text-black p-2 my-2 rounded-lg w-full"></textarea>
